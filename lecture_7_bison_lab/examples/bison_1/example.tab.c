...
#line 74 "example.tab.c" /* yacc.c:339  */
...
static const char *const yytname[] =
{
  ...
  "target_set", "heat_switch", YY_NULLPTR
};
#endif
...
#line 1203 "example.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 19 "example.y" /* yacc.c:1646  */
    { if((yyvsp[0])) printf("\tОбогреватель включен\n"); else printf("\tОбогреватель выключен\n"); }
#line 1209 "example.tab.c" /* yacc.c:1646  */
    break;
